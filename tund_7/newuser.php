<?php
	...
	if(isset($_POST["birthDay"])){
		...
		$birthDayError = "Palun märgi päev!";
	}
	
	if(isset($_POST["birthMonth"])){
		$birthMonth = $_POST["birthMonth"];
	}else{
		$birthMonthError = "Palun märgi kuu!";
	}
	
	if(isset($_POST["birthYear"])){
		$birthYear = $_POST["birthYear"];
	}else{
		$birthYearError = "Palun märgi aasta!";
	}
...
<body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<input name="lastName" type="text" value="<?php echo $surname; ?>"><span><?php echo $surnameError; ?></span><br>
		...
		?>
		<br>
		<?php echo $birthDayError. " ". $birthMonthError. " ". $birthYearError; ?>
		<br>
